...
const ASSET_CATEGORIES = {
  models: { name: "Root Models", icon: "📦", extensions: [".glb", ".gltf"], path: "/gltf/" },
  gameModels: { name: "Level Models", icon: "🗺️", extensions: [".glb", ".gltf"], path: "/game-assets/models/" },
  ...
  async refreshAssetBrowser(category = "models") {
    ...
    if (!this.assetCache) {
      ...
      this.assetCache.models = [
        { name: "phonebooth.glb", path: "/gltf/phonebooth.glb" },
        { name: "Old_Car_01.glb", path: "/gltf/Old_Car_01.glb" },
        { name: "radio-1.glb", path: "/gltf/radio-1.glb" },
      ];
      this.assetCache.gameModels = [
        { name: "musicroom.glb", path: "/game-assets/models/musicroom.glb" },
      ];
      this.assetCache.splats = [
        ...
        { name: "interior.sog", path: "/green-room-clean.sog" },
      ];
