// copyPosition.wgsl - Copy Positions to Render Buffer
// =====================================================
// Copies particle positions and velocities to the buffer used for rendering.
// Based on: https://github.com/matsuoka-601/WaterBall/blob/master/mls-mpm/copyPosition.wgsl
