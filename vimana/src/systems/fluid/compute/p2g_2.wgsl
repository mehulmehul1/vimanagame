// p2g_2.wgsl - Particle to Grid (Part 2: MLS-MPM Update)
// =====================================================
// Applies MLS-MPM constitutive model update to grid cells.
// Based on: https://github.com/matsuoka-601/WaterBall/blob/master/mls-mpm/p2g_2.wgsl
