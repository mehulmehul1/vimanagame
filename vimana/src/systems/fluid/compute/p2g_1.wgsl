// p2g_1.wgsl - Particle to Grid (Part 1: Mass & Velocity Transfer)
// ================================================================
// Transfers particle mass and velocity to grid cells using bicubic weights.
// Based on: https://github.com/matsuoka-601/WaterBall/blob/master/mls-mpm/p2g_1.wgsl
